...
with open(args.outputfile, 'w', encoding='utf-8') as of:
    input_file_list = os.listdir(args.inputpath)

    # Include the header if it exists and -h! not set
    if '.header.adoc' in input_file_list and not args.no_header:
    ...
    for filename in input_file_list:
        with open(os.path.join(args.inputpath, filename), "r", encoding='utf8') as infile:
